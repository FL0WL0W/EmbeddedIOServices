class ConfigBase {
    ...
    GetValue() {
        ...
        if(val === undefined && iniProperty.Value !== undefined) {
            val = GetValueByValueOrReference(iniProperty.Value, this.Obj, this.ObjLocation, this.Ini, this.IniLocation);
        }
    ...
    GetStep(){
        ...
        if(iniProperty.Step !== undefined) {
            step = GetValueByValueOrReference(iniProperty.Step, this.Obj, this.ObjLocation, this.Ini, this.IniLocation);
        }
        if(step === undefined) {
...
function GetValueByValueOrReference(val, obj, objLocation, ini, iniLocation) {
...
function GetIniPropertyPropertyGetFunction(propertyName, defaultValue) {
    var f = function() {
        ...
        if(iniProperty[propertyName] !== undefined) {
            val = GetValueByValueOrReference(iniProperty[propertyName], this.Obj, this.ObjLocation, this.Ini, this.IniLocation);
        }
        if(val)
            return val; 
...
function GetIniPropertyMin() {
    ...
    if(iniProperty.Min !== undefined) {
        min = GetValueByValueOrReference(iniProperty.Min, this.Obj, this.ObjLocation, this.Ini, this.IniLocation);
    }
    if(min === undefined) {
        switch(iniProperty.Type) {
            case "uint8":
...
function GetIniPropertyMax() {
    ...
    if(iniProperty.Max !== undefined) {
        max = GetValueByValueOrReference(iniProperty.Max, this.Obj, this.ObjLocation, this.Ini, this.IniLocation);
    }
    if(max === undefined) {
        switch(iniProperty.Type) {
            case "uint8":
