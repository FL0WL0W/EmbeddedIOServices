...
/****************************************************************************/
/*                          MODULE : PBRIDGb Peripheral Bridge            */
/****************************************************************************/
    ...
    struct PBRIDGb_tag {
        ...
        uint32_t PBRIDGb_reserved0008[6];  /* 0x0008-0x001F */
        ...
        uint32_t PBRIDGb_reserved002C[5];  /* 0x002C-0x003F */
        ...
        uint32_t PBRIDGb_reserved0050[4076];  /* 0x0050-0x3FFF */
...
/* wakeup status */
    ...
    typedef union uPCR16 {
        ...
        struct {
            ...
            vuint16_t NOISlisTEN_TIMEOUT_H:9;
        } B;
    } PCR16_t;
    ...
    typedef union uPCR17 {
        vuint16_t R;
        struct {
            vuint16_t NOISlisTEN_TIMEOUT_L:16;
        } B;
    } PCR17_t;
    ...
    typedef union uPCR26 {
        ...
        struct {
            ...
            vuint16_t COMP_ACCEPTED_STARTUP_RANGb:11;
...
#define PBRIDGb (*( volatile struct PBRIDGb_tag *)  0xFFF00000)
