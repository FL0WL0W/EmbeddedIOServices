...
namespace Stm32
{
	...
	extern "C" 
	{
		...
		void TIM1_CC_IRQHandler(void)
		{
			...
			{
				TIM1->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index1] != 0)
					_timer[TimerIndex::Index1]->TimerInterrupt();
		...
		void TIM2_CC_IRQHandler(void)
		{
			...
			{
				TIM2->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index2] != 0)
					_timer[TimerIndex::Index2]->TimerInterrupt();
		...
		void TIM3_CC_IRQHandler(void)
		{
			...
			{
				TIM3->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index3] != 0)
					_timer[TimerIndex::Index3]->TimerInterrupt();
		...
		void TIM4_CC_IRQHandler(void)
		{
			...
			{
				TIM4->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index4] != 0)
					_timer[TimerIndex::Index4]->TimerInterrupt();
		...
		void TIM5_CC_IRQHandler(void)
		{
			...
			{
				TIM5->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index5] != 0)
					_timer[TimerIndex::Index5]->TimerInterrupt();
		...
		void TIM6_CC_IRQHandler(void)
		{
			...
			{
				TIM6->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index6] != 0)
					_timer[TimerIndex::Index6]->TimerInterrupt();
		...
		void TIM7_CC_IRQHandler(void)
		{
			...
			{
				TIM7->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index7] != 0)
					_timer[TimerIndex::Index7]->TimerInterrupt();
		...
		void TIM8_CC_IRQHandler(void)
		{
			...
			{
				TIM8->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index8] != 0)
					_timer[TimerIndex::Index8]->TimerInterrupt();
		...
		void TIM9_CC_IRQHandler(void)
		{
			...
			{
				TIM9->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index9] != 0)
					_timer[TimerIndex::Index9]->TimerInterrupt();
		...
		void TIM10_CC_IRQHandler(void)
		{
			...
			{
				TIM10->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index10] != 0)
					_timer[TimerIndex::Index10]->TimerInterrupt();
		...
		void TIM11_CC_IRQHandler(void)
		{
			...
			{
				TIM11->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index11] != 0)
					_timer[TimerIndex::Index11]->TimerInterrupt();
		...
		void TIM12_CC_IRQHandler(void)
		{
			...
			{
				TIM12->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index12] != 0)
					_timer[TimerIndex::Index12]->TimerInterrupt();
		...
		void TIM13_CC_IRQHandler(void)
		{
			...
			{
				TIM13->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index13] != 0)
					_timer[TimerIndex::Index13]->TimerInterrupt();
		...
		void TIM14_CC_IRQHandler(void)
		{
			...
			{
				TIM14->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index14] != 0)
					_timer[TimerIndex::Index14]->TimerInterrupt();
		...
		void TIM15_CC_IRQHandler(void)
		{
			...
			{
				TIM15->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index15] != 0)
					_timer[TimerIndex::Index15]->TimerInterrupt();
		...
		void TIM16_CC_IRQHandler(void)
		{
			...
			{
				TIM16->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index16] != 0)
					_timer[TimerIndex::Index16]->TimerInterrupt();
		...
		void TIM17_CC_IRQHandler(void)
		{
			...
			{
				TIM17->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index17] != 0)
					_timer[TimerIndex::Index17]->TimerInterrupt();
		...
		void TIM18_CC_IRQHandler(void)
		{
			...
			{
				TIM18->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index18] != 0)
					_timer[TimerIndex::Index18]->TimerInterrupt();
		...
		void TIM19_CC_IRQHandler(void)
		{
			...
			{
				TIM19->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index19] != 0)
					_timer[TimerIndex::Index19]->TimerInterrupt();
		...
		void TIM20_CC_IRQHandler(void)
		{
			...
			{
				TIM20->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index20] != 0)
					_timer[TimerIndex::Index20]->TimerInterrupt();
		...
		void TIM21_CC_IRQHandler(void)
		{
			...
			{
				TIM21->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index21] != 0)
					_timer[TimerIndex::Index21]->TimerInterrupt();
		...
		void TIM22_CC_IRQHandler(void)
		{
			...
			{
				TIM22->SR = ~TIM_IT_CC1;
				if (_timer[TimerIndex::Index22] != 0)
					_timer[TimerIndex::Index22]->TimerInterrupt();
