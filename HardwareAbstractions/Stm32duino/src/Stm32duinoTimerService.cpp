...
namespace Stm32
{
	...
	Stm32duinoTimerService::Stm32duinoTimerService(uint8_t timer)
	{	
		...
		*timerCallBack = new CallBack<Stm32duinoTimerService>(this, &Stm32duinoTimerService::SetInterruptLatency);	
		TimInit(TIM, 0);
		...
		*timerCallBack = new CallBack<Stm32duinoTimerService>(this, &Stm32duinoTimerService::ReturnCallBack);
